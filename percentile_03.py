...
percentile_sector_1 = driver_laps.groupby('Driver')['Sector1(s)'].quantile(percentile_value)
percentile_sector_2 = driver_laps.groupby('Driver')['Sector2(s)'].quantile(percentile_value)
percentile_sector_3 = driver_laps.groupby('Driver')['Sector3(s)'].quantile(percentile_value)
