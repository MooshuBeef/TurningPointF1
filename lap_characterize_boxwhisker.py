...
sns.boxplot(telemetry_fastest_lap['Speed'])#, color="g", label="Overall Lap") #fill=True
#sns.boxplot(telemetry_fastest_lap_sector1['Speed'], color="deeppink", alpha=.7, label="Sector 1")
#sns.boxplot(telemetry_fastest_lap_sector2['Speed'], color="deeppink", alpha=.7, label="Sector 2")
